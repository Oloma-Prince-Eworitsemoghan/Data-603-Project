...
prediction <- suppressWarnings(
  predict(higher_order_interaction_model_wls_3, newdata, interval = "predict", level = 0.95)
)
...
knitr::kable(
  prediction_table,
  digits = 4,
  caption = "Predicted Median Home Value with 95% Prediction Interval"
)
```
 
Based on the prediction using the `predict()` function, we are **95% confident** that the median value (`medv`) of owner-occupied homes, given the specified predictor values, lies between **\$12,558** and **\$22,307**.

...
```{r}
reduced_additive_model = lm(formula = medv ~ crim + zn + chas + nox + rm+ dis + rad + tax + ptratio + b + lstat, data = boston_data)
...
$\hat{USAGE} = 5.891627 + 0.040207PROD+ 0.168673TEMP - 0.070990HOUR$

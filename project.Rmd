...
```
```{r}
lm(formula = medv ~ crim + zn + factor(chas) + nox + rm+ dis + rad + tax + ptratio + b + lstat+ crim:chas + crim:nox + crim:rm + crim:dis + crim:rad + crim:tax + crim:b + crim:lstat + zn:dis + zn:tax + chas:nox + chas:rm + chas:lstat + nox:tax + rm:ptratio + rm:b + rm:lstat + dis:rad + dis:lstat + b:lstat)
```
